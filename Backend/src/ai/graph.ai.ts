import { StateGraph, type GraphNode, StateSchema, START, END, MessagesValue } from "@langchain/langgraph";
import { z } from 'zod'
...
const judgeNode: GraphNode<typeof state> = async (state) => {
   ...
   const judge = createAgent({
      ...
      systemPrompt: `You are a judge tasked with evaluating two solutions generate by AI models.
